  ...
  return (
    <div className="p-4 container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1  lg:pt-8  gap-4 ">
            ...
            <Link to="/worker#project" className="bg-[#1F2025] space-y-10 py-36 rounded-lg shadow-2xl">
                <div>
                    <img src={Logo} alt="" />
                </div>
            ...
            <Link to="/worker#project2" className="bg-[#1F2025] space-y-10 py-36 rounded-lg shadow-2xl">
                <div>
                    <img src={Logo} alt="" />
                </div>
                <div className="text-center text-white font-extrabold font-mono text-4xl">
            ...
            <Link to="/worker#project3" className="bg-[#1F2025] space-y-10 py-36 rounded-lg shadow-2xl">
                <div>
                    <img src={Logo} alt="" />
                </div>
                <div className="text-center text-white font-extrabold font-mono text-4xl">
