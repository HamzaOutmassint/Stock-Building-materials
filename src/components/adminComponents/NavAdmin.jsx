    ...
    <div className="p-4 relative ">
      <div className="w-full bg-[#1F2025] p-4 rounded-lg flex justify-between">
        ...
        <div>
          ...
          <div className="absolute right-10 space-y-4  bg-[#4C4D53] p-6 rounded-lg"> 
          <div className="flex items-center gap-2">
            <img src={user} alt=""className="w-8" />
            <span className="text-center font-mono font-bold text-white text-xl">Votre compte</span>
          </div>
          <div className="flex items-center gap-2">
            <img src={adduser} alt=""className="w-8" />
            <span className="text-center font-mono font-bold text-white text-xl">Add new worker</span>
          </div>
          <div className="flex items-center gap-2">
            <img src={logout} alt=""className="w-8" />
            <span className="text-center font-mono font-bold text-white text-xl">Déconnexion</span>
          </div>
          </div>
